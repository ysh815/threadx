...
;{
_tx_timer_interrupt     PROC
    EXPORT  _tx_timer_interrupt
;
;    /* Upon entry to this routine, it is assumed that context save has already been called,
;       and therefore the compiler scratch registers are available for use.  */
;
