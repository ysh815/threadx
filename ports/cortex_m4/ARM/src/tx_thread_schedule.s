...
;{
;    .thumb_func
_tx_thread_schedule     PROC
    EXPORT  _tx_thread_schedule
;
;    /* This function should only ever be called on Cortex-M4 from the first schedule request.
;       Subsequent scheduling occurs from the PendSV handling routines below. */
;
